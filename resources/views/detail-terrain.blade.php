			...
			<div class="container">
				<div class="row">
					<div class="col-lg-5 col-md-12 col-12">
						...
						<div class="top-left">
							<ul class="list-main">
								<li><i class="ti-headphone-alt"></i> +221 78 525 38 54</li>
								<li><i class="ti-email"></i> nsbusiness@gmail.com</li>
							</ul>
						</div>
						<!--/ End Top Left -->
					</div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="blog-detail">
                                    <h2 class="blog-title">Description terrains?</h2>
                                    <div class="blog-meta">
                                    </div>
                                    <div class="content">
                                        <p>What a crazy time. I have five children in colleghigh school graduates.jpge or pursing post graduate studies  Each of my children attends college far from home, the closest of which is more than 800 miles away. While I miss being with my older children, I know that </p>
                                    </div>
                                </div>
